...
if ($_POST["email"]) $lext["ext"]["email"]=$_POST["email"];
...
if ($h_id_legajo){
	...
	if (!$_POST["leg_guardar"]){
		...
		$consulta="select id_legajo, hr_entra, hr_sale, ubicacion, id_afjp, id_usuario, login,
				estado_civil, fecha_estado_civil, nacionalidad, tipo_nacionalidad, email,
	...
	"tipo_nacionalidad"=>"0", "email"=>"", "baja_observaciones"=>"", "in_presentador"=>"",
...
if ($parametros["cmd"] == "modificar") {
	...
	if (!$error) {
		if ($_POST["leg_nuevo"] == "1") {
			...
			$id_legajo = $result->fields["id_legajo"];
			////////////////////////////////////////// Gabriel ///////////////////////////////////////////////////////
			$consulta="insert into legajos_ext (id_legajo, estado_civil, fecha_estado_civil, email, nacionalidad,
			...
			.(($lext["ext"]["email"])?"'".$lext["ext"]["email"]."'":"null").", "
		...
		elseif ($_POST["leg_nuevo"] == "0") {
			...
			if ($rta_consulta->recordCount()==1){
				...
				.", email=".(($lext["ext"]["email"])?"'".$lext["ext"]["email"]."'":"null")
			...
			/////////////////////// Gaby ////////////////////////////////
			//notificacion por mail al legajo ingresado del legajo
			...
			$ret .= "<td align='center'>\n";
			$ret .= "<b>Notificacion de Legajo Ingresado al sistema</b>\n";
			$ret .= "</td>\n";
			$ret .= "</tr>\n";
			$ret .= "<tr bgcolor='$color1' align='right'>\n";
			$ret .= "<td align='rigth'>\n";
			$ret .= "<b>Sistema de Gestion de Personal , $dia_hoy</b>\n";
			$ret .= "</td>\n";
			$ret .= "</tr>\n";
			$ret .= "<tr bgcolor='$color1' align='left'>\n";
			$ret .= "<td align='left'>\n";
			$ret .= "<b>Le imformamos que ha sido ingresado en el sistema de Legajos del Ministerio de Salud</b>\n";
			$ret .= "</td>\n";
			$ret .= "</tr>\n";
		
			$ret .= "</table><br>\n";
		
			 enviar_mail_html($email,'Notificacion Ingresado al sistema de Legajo ',$ret,0,0,0);
...
function form_modificar($nuevo = false,$id = "") {
	...
	<?echo "<tr>";
	echo "<td align=right><b>Correo e-mail:</b></td>";
	echo "<td align=left><input type=text name=email value='".$lext["ext"]["email"]."' size=30 onblur='validarEmail(this);'/></td>";
	echo "</tr>";?>
	<tr>
